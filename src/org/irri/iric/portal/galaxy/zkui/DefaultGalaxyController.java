...
public class DefaultGalaxyController implements GalaxyCustomController {
	...
	public String getGalaxyAddress(String instance) {
		...
		if (instance.equals(GALAXY_RICEDEV))
			...
			return "http://" + AppContext.getGalaxyIPAddress() + ":8080";
	}
	...
	/*
	 * @Override public void generateDataFiles() { // TODO Auto-generated method
	 * stub
	 * 
	 * }
	 * 
	 * @Override public Set checkEmbedList(String embed) { // TODO Auto-generated
	 * method stub return new HashSet(); }
	 * 
	 * @Override public Set getCommonClass() { // TODO Auto-generated method stub
	 * return new HashSet(); }
	 * 
	 * @Override public Set getCommonExt() { // TODO Auto-generated method stub
	 * return new HashSet(); }
	 */
	...
	private void generatePlinkfiles() {
		...
		/*
		 * GenotypeQueryParams p= fillGenotypeQueryParams(); haplofilename =
		 * "snp3kvars-" + queryFilename(); Object2StringMultirefsMatrixModel matrixmodel
		 * = (Object2StringMultirefsMatrixModel) biglistboxArray.getModel();
		 * VariantAlignmentTableArraysImpl table = (VariantAlignmentTableArraysImpl)
		 * matrixmodel.getData(); Map mapParamvals=new HashMap();
		 * mapParamvals.put("query",p); mapParamvals.put("table",table);
		 * mapParamvals.put("reference",
		 * this.listboxReference.getSelectedItem().getLabel() ); getSession().putValue(
		 * "param_vals",mapParamvals);
		 */
		...
		SNPQueryController.generateBigListboxPlink((VarietyFacade) AppContext.checkBean(varietyfacade, "VarietyFacade"),
				p, p.getsChr(), p.getDataset(), table, AppContext.getTempDir() + filename,
				(Map) mapParamvals.get("sample2pheno"), (String) mapParamvals.get("phenoname"));
