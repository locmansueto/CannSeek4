...
public class VCvtermLocuscountDAOTest {
	/**
	 * The DAO being tested, injected by Spring
	 *
	 */
	private VCvtermLocuscountDAO dataStore;

	/**
	 * Instantiates a new VCvtermLocuscountDAOTest.
	 *
	 */
	public VCvtermLocuscountDAOTest() {
	}

	/**
	 * Method to test VCvtermLocuscount domain object.
	 *
	 */
	@Rollback(false)
	@Test
	public void VCvtermLocuscount() {
		VCvtermLocuscount instance = new VCvtermLocuscount();
	 ...
	 */
	@Autowired
	public void setDataStore(VCvtermLocuscountDAO dataStore) {
