...
public final class PhylogenyWriter {
    ...
    public StringBuffer toNewHampshire( final Phylogeny tree, final boolean simple_newick, final boolean nh_write_distance_to_parent )
            throws IOException {
        setOutputFormt( FORMAT.NH );
        setWriteDistanceToParentInNH( nh_write_distance_to_parent );
       //System.out.println("tree " +  tree.toString() +"   " + tree.getNodeCount() + " nodes");
        return getOutput( tree );
    }
