...
public class VarietyDownloadsRowRenderer implements RowRenderer {
	...
	public void render(Row row, Object data, int index) throws Exception {
		...
		/*
		 * Checkbox chkbox = new Checkbox(); listchecks.add(index, chkbox );
		...
		/*
		 * createdownloadLinks(AppContext.getFastqURL() + var.getIrisId() + ".html",
		 * AppContext.getFastqURL() + var.getIrisId() + ".html",
		...
		/*
		 * createdownloadLinks(AppContext.getBamURL() + var.getIrisId() + ".html",
		 * AppContext.getBamURL() + var.getIrisId().replace(" ", "_") + ".html",
		 * AppContext.getBamURL() + var.getIrisId().replace(" ", "_") +
		 * ".html").setParent(row );
		 * 
		 * createdownloadLinks(AppContext.getVcfURL() + var.getIrisId() + ".html",
		 * AppContext.getVcfURL() + var.getIrisId().replace(" ", "_") + ".html",
		 * AppContext.getVcfURL() + var.getIrisId().replace(" ", "_") +
		 * ".html").setParent(row );
		 */
		 ...
		 * 
		 * Button butt = new Button(); butt.setHeight("30px"); butt.setWidth("55px");
		 * butt.setImage("images/iric/awshttp.png"); butt.setHref(
		 * AppContext.getFastqURL() + var.getIrisId() + ".html" );
		 * butt.setParent(hboxButtons);
		 * 
		 * Hbox hboxPadd1 = new Hbox(); hboxPadd1.setWidth("10px");
		 * hboxButtons.appendChild(hboxPadd1);
		 * 
		 * butt = new Button(); butt.setHeight("30px"); butt.setWidth("55px");
		 * butt.setImage("images/iric/astihttp.png"); butt.setHref(
		 * AppContext.getFastqURL() + var.getIrisId() + ".html" );
		 * butt.setParent(hboxButtons);
		 * 
		 * Hbox hboxPadd2 = new Hbox(); hboxPadd2.setWidth("10px");
		 * hboxButtons.appendChild(hboxPadd2);
		 * 
		 * butt = new Button(); butt.setHeight("30px"); butt.setWidth("55px");
		 * butt.setImage("images/iric/astiftp.png"); butt.setHref(
		 * AppContext.getFastqURL() + var.getIrisId() + ".html" );
		 * butt.setParent(hboxButtons);
		 * 
	...
	private Hbox createdownloadLinks(String href1) {
		...
		/*
		 * butt = new Button(); butt.setHeight("30px"); butt.setWidth("55px");
		 * butt.setSclass("myimgbutton"); butt.setImage("images/iric/astihttp.png");
		 * butt.setHref( href2 ); butt.setTarget("_rawdownload");
		 * butt.setParent(hboxButtons);
		 * 
		 * Hbox hboxPadd2 = new Hbox(); hboxPadd2.setWidth("10px");
		 * hboxButtons.appendChild(hboxPadd2);
		 * 
		 * butt = new Button(); butt.setHeight("30px"); butt.setWidth("55px");
		 * butt.setSclass("myimgbutton"); butt.setImage("images/iric/astiftp.png");
		 * butt.setHref( href3 ); butt.setTarget("_rawdownload");
		 * butt.setParent(hboxButtons);
		 */
		return hboxButtons;
	}
