...
public class VSnpSplicedonorDAOTest {
	/**
	 * The DAO being tested, injected by Spring
	 *
	 */
	private VSnpSplicedonorDAO dataStore;

	/**
	 * Instantiates a new VSnpSplicedonorDAOTest.
	 *
	 */
	public VSnpSplicedonorDAOTest() {
	}

	/**
	 * Method to test VSnpSplicedonor domain object.
	 *
	 */
	@Rollback(false)
	@Test
	public void VSnpSplicedonor() {
		VSnpSplicedonor instance = new VSnpSplicedonor();
	 ...
	 */
	@Autowired
	public void setDataStore(VSnpSplicedonorDAO dataStore) {
