...
public class PhylotreeServiceImpl implements PhylotreeService {
	...
	public Object[] constructPhylotree(PhylotreeQueryParams params, String requestid) {
		...
		// return (String[])constructPhylotreeMindist(
		// Double.toString(params.getScale()) , params.getGenotype().getsChr(),
		// params.getGenotype().getlStart().intValue(),
		// params.getGenotype().getlEnd().intValue() , Double.toString(
		// params.getMinDist()));
