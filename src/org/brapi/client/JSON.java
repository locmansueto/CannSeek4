    ...
    public <T> T deserialize(String body, Type returnType) {
        try {
            if (apiClient.isLenientOnJson()) {
                ...
                //return gson.fromJson(jsonReader, returnType); // .fromJson(jsonReader, returnType);
                return gson.fromJson(new StringReader(body), returnType); // .fromJson(jsonReader, returnType);
            } else {
