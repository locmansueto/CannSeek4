...
#ICGRC
legendpath="/usr/local/tomcat/webapps/cannseek/haplo/legend.png"
...
ec=paste0("python rename-pednames.py ", pedfilename)
ec
system(ec)
...
cmd=paste0("python create-summary.py ", pedfilename)
cmd
system(cmd)
