...
public class VCvPassportDAOTest {
	/**
	 * The DAO being tested, injected by Spring
	 *
	 */
	private VCvPassportDAO dataStore;

	/**
	 * Instantiates a new VCvPassportDAOTest.
	 *
	 */
	public VCvPassportDAOTest() {
	}

	/**
	 * Method to test VCvPassport domain object.
	 *
	 */
	@Rollback(false)
	@Test
	public void VCvPassport() {
		VCvPassport instance = new VCvPassport();
	 ...
	 */
	@Autowired
	public void setDataStore(VCvPassportDAO dataStore) {
