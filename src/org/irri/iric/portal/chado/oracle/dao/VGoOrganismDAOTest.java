...
public class VGoOrganismDAOTest {
	/**
	 * The DAO being tested, injected by Spring
	 *
	 */
	private VGoOrganismDAO dataStore;

	/**
	 * Instantiates a new VGoOrganismDAOTest.
	 *
	 */
	public VGoOrganismDAOTest() {
	}

	/**
	 * Method to test VGoOrganism domain object.
	 *
	 */
	@Rollback(false)
	@Test
	public void VGoOrganism() {
		VGoOrganism instance = new VGoOrganism();
	 ...
	 */
	@Autowired
	public void setDataStore(VGoOrganismDAO dataStore) {
