...
public class VLocusNotesDAOTest {
	/**
	 * The DAO being tested, injected by Spring
	 *
	 */
	private VLocusNotesDAO dataStore;

	/**
	 * Instantiates a new VLocusNotesDAOTest.
	 *
	 */
	public VLocusNotesDAOTest() {
	}

	/**
	 * Method to test VLocusNotes domain object.
	 *
	 */
	@Rollback(false)
	@Test
	public void VLocusNotes() {
		VLocusNotes instance = new VLocusNotes();
	 ...
	 */
	@Autowired
	public void setDataStore(VLocusNotesDAO dataStore) {
