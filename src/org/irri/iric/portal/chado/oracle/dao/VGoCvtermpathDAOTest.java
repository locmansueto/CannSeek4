...
public class VGoCvtermpathDAOTest {
	/**
	 * The DAO being tested, injected by Spring
	 *
	 */
	private VGoCvtermpathDAO dataStore;

	/**
	 * Instantiates a new VGoCvtermpathDAOTest.
	 *
	 */
	public VGoCvtermpathDAOTest() {
	}

	/**
	 * Method to test VGoCvtermpath domain object.
	 *
	 */
	@Rollback(false)
	@Test
	public void VGoCvtermpath() {
		VGoCvtermpath instance = new VGoCvtermpath();
	 ...
	 */
	@Autowired
	public void setDataStore(VGoCvtermpathDAO dataStore) {
