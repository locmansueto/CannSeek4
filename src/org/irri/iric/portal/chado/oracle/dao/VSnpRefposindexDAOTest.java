...
public class VSnpRefposindexDAOTest {
	/**
	 * The DAO being tested, injected by Spring
	 *
	 */
	private VSnpRefposindexDAO dataStore;

	/**
	 * Instantiates a new VSnpRefposindexDAOTest.
	 *
	 */
	public VSnpRefposindexDAOTest() {
	}

	/**
	 * Method to test VSnpRefposindex domain object.
	 *
	 */
	@Rollback(false)
	@Test
	public void VSnpRefposindex() {
		VSnpRefposindex instance = new VSnpRefposindex();
	 ...
	 */
	@Autowired
	public void setDataStore(VSnpRefposindexDAO dataStore) {
