...
public interface VConvertposNb2allrefsDAO extends JpaDao<VConvertposNb2allrefs>, MultipleReferenceConverterDAO {
	 ...
	 *
	 */
	public VConvertposNb2allrefs findVConvertposNb2allrefsByPrimaryKey(BigDecimal snpFeatureId_1)
			throws DataAccessException;
	 ...
	 *
	 */
	public VConvertposNb2allrefs findVConvertposNb2allrefsByPrimaryKey(BigDecimal snpFeatureId_1, int startResult,
			int maxRows) throws DataAccessException;
	 ...
	 *
	 */
	public Set<VConvertposNb2allrefs> findVConvertposNb2allrefsByFromRefcallContaining(String fromRefcall_1)
			throws DataAccessException;
	 ...
	 *
	 */
	public Set<VConvertposNb2allrefs> findVConvertposNb2allrefsByFromOrganismId(BigDecimal fromOrganismId,
			int startResult, int maxRows) throws DataAccessException;
